    ...
    <div class="w-full md:w-1/2 flex flex-col items-center justify-center p-8 lg:p-16 relative">
        <div class="w-full max-w-md">
            ...
            <div class="mt-8 grid grid-cols-2 gap-4">
                <button onclick={handleGoogleLogin} class="flex items-center justify-center py-3 bg-[#111] border border-zinc-800 rounded-sm hover:bg-zinc-900 transition-colors shadow-sm">
                ...
                <button type="button" class="flex items-center justify-center py-3 bg-[#111] border border-zinc-800 rounded-sm hover:bg-zinc-900 transition-colors shadow-sm">
                    <svg class="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16.365 7.143c.828-1.002 1.385-2.4 1.233-3.793-1.192.048-2.648.793-3.498 1.815-.765.897-1.436 2.336-1.258 3.7.159 1.282.049.034 1.341 1.22-.05.006.126.002.041.026 1.109-.044 2.141-.837 2.141-.837s-.008.016 0-.005l.006-.01zm2.348 9.387c-.822 1.196-1.681 2.365-2.928 2.389-1.217.024-1.62-.716-3.023-.716-1.416 0-1.855.692-3.007.74-1.196.048-2.182-1.268-3.018-2.464-1.705-2.464-3.009-6.953-2.13-9.94.436-1.482 1.543-2.44 2.802-2.465 1.197-.024 2.337.804 3.064.804.726 0 2.052-.962 3.497-.82 1.489.144 2.842.864 3.702 2.124-3.239 1.884-2.68 6.442.492 7.749-.757 1.821-1.637 3.8-2.451 4.795z"/></svg>
                </button>
            </div>
        </div>
    </div>
